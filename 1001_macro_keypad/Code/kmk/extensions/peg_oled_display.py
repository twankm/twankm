...
class Oled(Extension):
    ...
    def during_bootup(self, keyboard):
        displayio.release_displays()
        i2c = busio.I2C(keyboard.SCL, keyboard.SDA, frequency=100000)
        ...
        self.DISPLAY.enable()  # Optional, if using a display
        i2c.try_lock()
        i2c.writeto(0x00, b'')  # Write to a nonexistent address to trigger internal pull-ups
        i2c.unlock()
        if self._toDisplay == OledDisplayMode.TXT:
